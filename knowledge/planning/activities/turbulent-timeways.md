...
- **5 TW dungeons/week** completes the weekly quest → a **Heroic Cache of Quel'Thalas**
  (one Heroic-track piece, ilvl **259–276**).
- **Mount:** *Spawn of Vyranoth* (new proto-drake) requires earning **Mastery of Timeways in
  4 of the event's weeks** (miss at most one) — creators phrase the track as "4 of 5"
  (`kUP8oqI7Ekc`) / "5 different weeks" (`rliFXbEHghU`); can be spread across alts.

**Cross-character star case:** `goal:leveling` + +30% XP makes this a top pick on an alt
(Uncomplete/Hallick) *only while live* — the exact "1 hour → level the alt" flip.
