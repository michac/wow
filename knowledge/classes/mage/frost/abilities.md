...
> measured, and the tsv's `cooldown` column returns the **GCD** for charge-based
> abilities (Blink/Shimmer read `0.5`), so it cannot answer those. This table is for
> **function, role and rotational context**.
