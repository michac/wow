---
title: Demonology Warlock — simc APL (generated)
patch: 12.1
fetched: 2026-08-17
reviewed: 2026-08-17
sources:
  - https://raw.githubusercontent.com/simulationcraft/simc/midnight/engine/class_modules/apl/warlock.cpp  # tier 1, simc APL source for demonology, commit 51d49d5 (2026-08-12)
verbatim: true
confidence: high
---

# Demonology Warlock — the simc priority list
...
<!-- gen_simc:begin -->
_Generated by `wowkb.simc --kb` from `engine/class_modules/apl/warlock.cpp` (`demonology` block), commit `51d49d5` (2026-08-12). 61 actions. Do not hand-edit._
...
actions.default+=/potion,if=pet.demonic_tyrant.active|fight_remains<=30
actions.default+=/invoke_external_buff,name=power_infusion,if=pet.demonic_tyrant.active
actions.default+=/call_action_list,name=racials,if=pet.demonic_tyrant.active|fight_remains<22,use_off_gcd=1
actions.default+=/call_action_list,name=items,use_off_gcd=1
actions.default+=/call_action_list,name=diabolist,if=talent.diabolic_ritual
actions.default+=/call_action_list,name=soulharvest,if=talent.demonic_soul
