---
title: Frost Death Knight — simc APL (generated)
patch: 12.1
fetched: 2026-08-17
reviewed: 2026-08-17
sources:
  - https://raw.githubusercontent.com/simulationcraft/simc/midnight/engine/class_modules/apl/apl_death_knight.cpp  # tier 1, simc APL source for frost
verbatim: true
confidence: high
pass: 2026-08-17.1
---

# Frost Death Knight — the simc priority list
...
<!-- gen_simc:begin -->
_Generated by `wowkb.simc --kb` from `engine/class_modules/apl/apl_death_knight.cpp` (`frost` block), commit unresolved (`--no-sha`, or the API was rate-limited). 84 actions. Do not hand-edit._
...
actions.default+=/run_action_list,name=aoe,if=active_enemies>=2
...
actions.aoe+=/glacial_advance,if=!variable.rp_pooling&active_enemies>=3
actions.aoe+=/frost_strike,if=!variable.rp_pooling&active_enemies<=2
...
actions.cooldowns+=/frostwyrms_fury,if=((talent.apocalypse_now|talent.chosen_of_frostbrood)&!buff.chosen_of_frostbrood_fwf.up)&variable.sending_cds&(!talent.breath_of_sindragosa&buff.pillar_of_frost.up|buff.breath_of_sindragosa.up)|(fight_remains<20&!buff.chosen_of_frostbrood_haste.up)
...
actions.variables+=/variable,name=frostscythe_priority,value=2
