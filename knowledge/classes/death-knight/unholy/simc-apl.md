---
title: Unholy Death Knight — simc APL (generated)
patch: 12.1
fetched: 2026-08-17
reviewed: 2026-08-17
sources:
  - https://raw.githubusercontent.com/simulationcraft/simc/midnight/engine/class_modules/apl/apl_death_knight.cpp  # tier 1, simc APL source for unholy
verbatim: true
confidence: high
pass: 2026-08-17.1
---

# Unholy Death Knight — the simc priority list
...
<!-- gen_simc:begin -->
_Generated by `wowkb.simc --kb` from `engine/class_modules/apl/apl_death_knight.cpp` (`unholy` block), commit unresolved (`--no-sha`, or the API was rate-limited). 64 actions. Do not hand-edit._
...
actions.default+=/potion,if=(variable.st_planning|variable.adds_remain)&variable.cds_active&(variable.trinket_priority=1&trinket.1.has_use_buff&!trinket.1.proc.mastery.duration>0|variable.trinket_priority=2&trinket.2.has_use_buff&!trinket.2.proc.mastery.duration>0)
actions.default+=/call_action_list,name=trinkets
actions.default+=/call_action_list,name=cooldowns
actions.default+=/call_action_list,name=aoe,if=active_enemies>=3
actions.default+=/call_action_list,name=single_target,if=active_enemies<3
