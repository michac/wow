...
reviewed: 2026-08-17
sources:
  - https://raw.githubusercontent.com/simulationcraft/simc/midnight/engine/class_modules/apl/apl_death_knight.cpp  # tier 1, simc APL source for blood, commit debdca3 (2026-08-09)
verbatim: true
confidence: high
---
...
<!-- gen_simc:begin -->
_Generated by `wowkb.simc --kb` from `engine/class_modules/apl/apl_death_knight.cpp` (`blood` block), commit `debdca3` (2026-08-09). 65 actions. Do not hand-edit._
