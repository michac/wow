---
title: Retribution Paladin — simc APL (generated)
patch: 12.1
fetched: 2026-08-17
reviewed: 2026-08-17
sources:
  - https://raw.githubusercontent.com/simulationcraft/simc/midnight/engine/class_modules/apl/apl_paladin.cpp  # tier 1, simc APL source for retribution
verbatim: true
confidence: high
pass: 2026-08-17.1
---

# Retribution Paladin — the simc priority list
...
<!-- gen_simc:begin -->
_Generated by `wowkb.simc --kb` from `engine/class_modules/apl/apl_paladin.cpp` (`retribution` block), commit unresolved (`--no-sha`, or the API was rate-limited). 40 actions. Do not hand-edit._
...
actions.default+=/rebuke
actions.default+=/call_action_list,name=cooldowns
actions.default+=/call_action_list,name=generators
