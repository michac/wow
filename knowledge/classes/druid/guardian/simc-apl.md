...
reviewed: 2026-08-17
sources:
  - https://raw.githubusercontent.com/simulationcraft/simc/midnight/engine/class_modules/apl/druid/guardian_apl.inc  # tier 1, simc APL source for guardian
verbatim: true
confidence: high
pass: 2026-08-17.1
---
...
<!-- gen_simc:begin -->
_Generated by `wowkb.simc --kb` from `engine/class_modules/apl/druid/guardian_apl.inc` (`guardian` block), commit unresolved (`--no-sha`, or the API was rate-limited). 54 actions. Do not hand-edit._
