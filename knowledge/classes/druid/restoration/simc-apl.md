...
reviewed: 2026-08-17
sources:
  - https://raw.githubusercontent.com/simulationcraft/simc/midnight/engine/class_modules/apl/druid/restoration_druid_apl.inc  # tier 1, simc APL source for restoration, commit e66adb6 (2026-08-11)
verbatim: true
confidence: high
---
...
<!-- gen_simc:begin -->
_Generated by `wowkb.simc --kb` from `engine/class_modules/apl/druid/restoration_druid_apl.inc` (`restoration` block), commit `e66adb6` (2026-08-11). 41 actions. Do not hand-edit._
