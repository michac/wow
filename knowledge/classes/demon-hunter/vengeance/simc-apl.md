---
title: Vengeance Demon Hunter — simc APL (generated)
patch: 12.1
fetched: 2026-08-17
reviewed: 2026-08-17
sources:
  - https://raw.githubusercontent.com/simulationcraft/simc/midnight/engine/class_modules/apl/apl_demon_hunter.cpp  # tier 1, simc APL source for vengeance
verbatim: true
confidence: high
pass: 2026-08-17.1
---

# Vengeance Demon Hunter — the simc priority list
...
<!-- gen_simc:begin -->
_Generated by `wowkb.simc --kb` from `engine/class_modules/apl/apl_demon_hunter.cpp` (`vengeance` block), commit unresolved (`--no-sha`, or the API was rate-limited). 203 actions. Do not hand-edit._
...
actions.default+=/variable,name=single_target,value=spell_targets.spirit_bomb=1
actions.default+=/variable,name=aoe,value=spell_targets.spirit_bomb>=3
actions.default+=/variable,name=execute,value=fight_remains<20
actions.default+=/variable,name=is_dungeon,value=fight_style.dungeonroute|fight_style.dungeonslice
actions.default+=/cycling_variable,name=dung_pull_ttd,op=reset
actions.default+=/cycling_variable,name=dung_pull_ttd,op=max,value=target.time_to_die
actions.default+=/variable,name=dung_next_pull,value=variable.is_dungeon&raid_event.adds.exists&raid_event.pull.remains<12&(raid_event.adds.has_boss|raid_event.adds.count>=3)
actions.default+=/variable,name=dung_cd_ok,value=variable.execute|!variable.is_dungeon|(variable.dung_pull_ttd>12&!variable.dung_next_pull)
actions.default+=/variable,name=dung_meta_ok,value=variable.execute|!variable.is_dungeon|(variable.dung_pull_ttd>(15-5*hero_tree.annihilator)&!variable.dung_next_pull)
actions.default+=/variable,name=trinket_1_buffs,value=trinket.1.has_use_buff|(trinket.1.has_buff.agility|trinket.1.has_buff.mastery|trinket.1.has_buff.versatility|trinket.1.has_buff.haste|trinket.1.has_buff.crit|trinket.1.has_buff.attack_power)
actions.default+=/variable,name=trinket_2_buffs,value=trinket.2.has_use_buff|(trinket.2.has_buff.agility|trinket.2.has_buff.mastery|trinket.2.has_buff.versatility|trinket.2.has_buff.haste|trinket.2.has_buff.crit|trinket.2.has_buff.attack_power)
actions.default+=/variable,name=trinket_priority,op=setif,value=2,value_else=1,condition=!variable.trinket_1_buffs&variable.trinket_2_buffs|variable.trinket_2_buffs&((trinket.2.proc.any_dps.duration)*trinket.2.proc.any_dps.default_value)>((trinket.1.proc.any_dps.duration)*trinket.1.proc.any_dps.default_value)
actions.default+=/variable,name=damage_trinket_priority,op=setif,value=2,value_else=1,condition=!variable.trinket_1_buffs&!variable.trinket_2_buffs&trinket.2.ilvl>=trinket.1.ilvl
actions.default+=/variable,name=fiery_demise_active,value=talent.fiery_demise&dot.fiery_brand.ticking
actions.default+=/variable,name=fire_cd_soon,value=cooldown.soul_carver.remains>?cooldown.fel_devastation.remains>?cooldown.sigil_of_spite.remains<(8+talent.charred_flesh.rank)
actions.default+=/variable,name=fragment_target,op=setif,value=5+apex.2,value_else=variable.fiery_demise_active*3+!variable.fiery_demise_active*(5-buff.metamorphosis.up),condition=hero_tree.aldrachi_reaver
actions.default+=/auto_attack
actions.default+=/retarget_auto_attack,target_if=min:debuff.reavers_mark.remains,if=hero_tree.aldrachi_reaver
actions.default+=/disrupt,if=target.debuff.casting.react
actions.default+=/infernal_strike,use_off_gcd=1
actions.default+=/demon_spikes,use_off_gcd=1,if=!buff.demon_spikes.up&in_combat
actions.default+=/run_action_list,name=ar,if=hero_tree.aldrachi_reaver
actions.default+=/run_action_list,name=anni,if=hero_tree.annihilator
