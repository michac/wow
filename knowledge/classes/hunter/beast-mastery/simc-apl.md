---
title: Beast Mastery Hunter — simc APL (generated)
patch: 12.1
fetched: 2026-08-17
reviewed: 2026-08-17
sources:
  - https://raw.githubusercontent.com/simulationcraft/simc/midnight/engine/class_modules/apl/apl_hunter.cpp  # tier 1, simc APL source for beast_mastery, commit 7ba3610 (2026-08-17)
verbatim: true
confidence: high
pass: 2026-08-17.1
---

# Beast Mastery Hunter — the simc priority list
...
<!-- gen_simc:begin -->
_Generated by `wowkb.simc --kb` from `engine/class_modules/apl/apl_hunter.cpp` (`beast_mastery` block), commit `7ba3610` (2026-08-17). 56 actions. Do not hand-edit._
...
actions.default+=/call_action_list,name=drst,if=talent.black_arrow&(active_enemies<2|!talent.beast_cleave&active_enemies<3)
actions.default+=/call_action_list,name=drcleave,if=talent.black_arrow&(active_enemies>2|talent.beast_cleave&active_enemies>1)
actions.default+=/call_action_list,name=st,if=!talent.black_arrow&(active_enemies<2|!talent.beast_cleave&active_enemies<3)
actions.default+=/call_action_list,name=cleave,if=!talent.black_arrow&(active_enemies>2|talent.beast_cleave&active_enemies>1)
...
actions.drst+=/cobra_shot,if=buff.cobra_fang.stack>3
...
actions.st+=/kill_command,if=howl_summon.ready
actions.st+=/kill_command,if=(cooldown.bestial_wrath.remains>full_recharge_time+gcd&buff.natures_ally.react|!apex.3)&(buff.howl_of_the_pack_leader_cooldown.remains>4|cooldown.kill_command.charges_fractional>1.8)
actions.st+=/cobra_shot,if=buff.cobra_fang.stack>=3
