...
> source of record for **name, spellID, origin and cooldown** across every table below
> (generated from DB2 @ `12.0.7.67808`). These tables are the *judgement* layer —
> function, role, rotational context — and do not re-transcribe columns that drift with
> every build.
