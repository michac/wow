...
reviewed: 2026-08-17
sources:
  - https://raw.githubusercontent.com/simulationcraft/simc/midnight/engine/class_modules/apl/apl_monk.cpp  # tier 1, simc APL source for brewmaster, commit a3fe60d (2026-08-12)
verbatim: true
confidence: high
---
...
<!-- gen_simc:begin -->
_Generated by `wowkb.simc --kb` from `engine/class_modules/apl/apl_monk.cpp` (`brewmaster` block), commit `a3fe60d` (2026-08-12). 62 actions. Do not hand-edit._
