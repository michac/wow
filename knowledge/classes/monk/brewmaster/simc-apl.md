---
title: Brewmaster Monk — simc APL (generated)
patch: 12.1
fetched: 2026-08-17
reviewed: 2026-08-17
sources:
  - https://raw.githubusercontent.com/simulationcraft/simc/midnight/engine/class_modules/apl/apl_monk.cpp  # tier 1, simc APL source for brewmaster
verbatim: true
confidence: high
pass: 2026-08-17.1
---

# Brewmaster Monk — the simc priority list
...
<!-- gen_simc:begin -->
_Generated by `wowkb.simc --kb` from `engine/class_modules/apl/apl_monk.cpp` (`brewmaster` block), commit unresolved (`--no-sha`, or the API was rate-limited). 62 actions. Do not hand-edit._

```
actions.precombat+=/snapshot_stats
actions.precombat+=/potion
actions.default+=/auto_attack
actions.default+=/potion
actions.default+=/call_action_list,name=race_actions
actions.default+=/call_action_list,name=item_actions
actions.default+=/run_action_list,name=master_of_harmony,if=hero_tree.master_of_harmony
actions.default+=/run_action_list,name=shado_pan,if=hero_tree.shadopan
