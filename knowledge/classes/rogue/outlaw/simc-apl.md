...
reviewed: 2026-08-17
sources:
  - https://raw.githubusercontent.com/simulationcraft/simc/midnight/engine/class_modules/apl/apl_rogue.cpp  # tier 1, simc APL source for outlaw
verbatim: true
confidence: high
pass: 2026-08-17.1
---
...
<!-- gen_simc:begin -->
_Generated by `wowkb.simc --kb` from `engine/class_modules/apl/apl_rogue.cpp` (`outlaw` block), commit unresolved (`--no-sha`, or the API was rate-limited). 48 actions. Do not hand-edit._
