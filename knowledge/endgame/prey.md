...
New repeatable hunt system introduced with Midnight.
...
- **10 ranks.** Points: **first 4 hunts each week = 1,000 pts each;
...
- Nightmare rewards: champion-track gear, Veteran Dawncrests, Voidlight
  Marl, Tormented Tantalum chance — and per 12.0.5 sources, **Ascendant
...
- [ ] Hunt difficulty tiers (normal vs Nightmare) and scaling
