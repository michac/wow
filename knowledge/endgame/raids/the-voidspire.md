---
title: The Voidspire (Raid — Midnight Season 1)
patch: 12.0.7
fetched: 2026-06-19
sources:
...
- [ ] Loot ilvls per difficulty; tier tokens; very rares — *still open: the
      12.0.7 ledger only gives ilvl ranges for the new Sporefall raid (259–298),
      not Voidspire. Verify Voidspire ilvls against wago.tools / Blizzard API.*
