...
|---|---|---|---|---|---|
| Dread Souleater | **Necrotic Wave** | Arcs to all nearby; applies a healing absorb → stagger defensives/healing CDs to clear it | heal-absorb | 🟠 | all (healer) |
...
| Gloomwing Bat | **Piercing Screech** | Line toward the tank → interrupt; tank points it away if it goes off | interruptible-cast | 🔵 | all (tank) |
