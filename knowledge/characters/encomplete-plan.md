...
- [ ] **Spark crafts** via crafting orders (Mar'nah, Silvermoon) — all
  ...
  - [ ] Belt 214→259 — 2 sparks (no embellishment — at the 2 cap)
...
4. [ ] **6 keyed bountiful delves**, highest tier clearable (T9 now,
       T11 when comfortable): open every **Bountiful Coffer** (hero 259
       at T8+), ~1.3 Delver's Journey ranks/week
...
8. [ ] Housing weekly, renown pushes, Trading Post — flavor, last
