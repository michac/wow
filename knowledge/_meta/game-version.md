...
| Live patch | **12.0.7** (live client build `12.0.7.68887`, 2026-07-23; Game Data API static namespace = 12.0.7) |
| PTR patch | **12.1 "Curse of Ula'tek"** on PTR (build `12.1.0.68914`, 2026-07-24) — opens Midnight Season 2; see `next-patch.md` |
| Level cap | **90** |
