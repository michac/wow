...
- A parallel **rune tree**, opened from a **minimap icon**, separate from
  talents. It does **not** occupy a gear slot and has **no respec cost**.
- **5 rows.** Row 1 is the **core** slot; rows 2–5 are choice rows. Each
  row offers **2–4 rune options**; you slot **one rune per row**.
...
You help **Magister Umbric** and **Grand Magister Rommath** restore the
**Sunstrider Omnium** — an ancient Thalassian relic created by **Dath'Remar
Sunstrider** to study and preserve the schools of magic. Work is based out
of the Magisters' Terrace library / Thalassian University in Silvermoon.

## Unlock & weekly cadence
...
- Completing **all 5** Seeking Knowledge quests awards the **Sunstrider
  Omnium Simulacrum** housing decor item.

## Runes (datamined / early-build names — verify on live)

Names below are from Tier 3/4 datamining and may rename or retune before
...
- **Row 5 (amplification):** Overload · Residual Energy · Echoes

## Notes

- Per Blizzard's framing this is the Midnight equivalent of a borrowed-power
  system that **persists for the whole expansion** rather than being reset
  next season — closer to a permanent account progression track.
- Currency name appears as **"Mote of Omnial Inquiry"** (Icy Veins,
  Conquest Capped); one secondary guide called it "Omnium Research
  Particles." Mote is the better-corroborated name.
