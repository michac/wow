...
> mechanics prose lives. ⚠ **Neither is restated here; this file cites them** — added 2026-09-01,
> since the other catalogs carried this sentence and this one did not. §2's *"13 distinct presses
> in first-occurrence order"* is a **census** — it counts presses to size the roster and carries no
> conditions — not a priority list to be read instead of the APL. Every rung number below counts lines **within
