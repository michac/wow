...
**Hero trees.** `builds.md` owns the pick. In kit terms: **Annihilator** ramps
*Voidfall* stacks that call down Void Meteors; **Void-Scarred** is Void
Metamorphosis-centric, and its melee-hybrid variant weaves The Hunt / Hungering
Slash / Voidblade.
