...
- **Herald of the Sun** — **Divine Toll** and **Holy Prism** seed **Dawnlight**
  HoTs, and during Avenging Wrath / Avenging Crusader those Dawnlights link
  beam-lines (**Sun's Avatar**) that heal/damage anything crossing them.
- **Lightsmith** — adds **Holy Armaments**, alternating a **Sacred Weapon** buff
  with a **Holy Bulwark** absorb, plus Solidarity and Hammer and Anvil.
