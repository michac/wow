...
**Hero trees.** `builds.md` owns the pick. In kit terms: **Rider of the
Apocalypse** adds no button — the Four Horsemen ride along with your cooldown
windows; **San'layn** adds **Vampiric Strike**, which replaces some Scourge
Strikes.
