...
- **Slayer** — **Bloodthirst → Bloodbath** and **Raging Blow → Crushing Blow**
  during its windows (via **Reckless Abandon**), plus **Slayer's Dominance**
  stacks and **Bladestorm** cooldown reduction through **Unrelenting Onslaught**.
- **Mountain Thane** — replaces **Whirlwind** with **Thunder Clap** in the
  rotation and adds **Lightning Strikes** procs plus **Thunder Blast** (an
  empowered Thunder Clap that extends Avatar).
