...
- **Hero trees:** `builds.md` owns the pick. In kit terms: **Keeper of the
  Grove** makes **Force of Nature** a rotational button (Treants + Harmony of
  the Grove); **Elune's Chosen** centres **Fury of Elune** and **disables Solar
  Eclipse** — you always enter Lunar.
