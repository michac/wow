...
- **Conduit of the Celestials** — adds **Celestial Conduit** (a channeled AoE
  heal/damage nuke), **Heart of the Jade Serpent** cooldown reduction, and
  **Unity Within**. Builds a ramping Renewing Mist / Rushing Wind Kick loop.
- **Master of Harmony** — routes healing/damage through **Aspect of Harmony**,
  banked and released; largely passive beyond activating Thunder Focus Tea.
