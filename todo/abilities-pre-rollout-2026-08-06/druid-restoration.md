...
- **Hero trees:** **Keeper of the Grove** (Grove Guardian treant summons tied
  to Swiftmend/Wild Growth, cooldown reduction, *Protective Growth* defense) and
  **Wildstalker** (Symbiotic Blooms from Wild Growth/Regrowth/Efflorescence that
  amplify regular healing, plus a cat-weaving damage loop). `builds.md` owns the
  pick — and records it as **contested** in S1.
