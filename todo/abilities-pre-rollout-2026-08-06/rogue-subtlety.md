...
**Hero trees.** `builds.md` owns the pick. In kit terms: **Trickster**'s Unseen
Blade applies *Fazed* and feeds the **Coup de Grace** finisher via Flawless Form
stacks; **Deathstalker**'s **Shadowstrike** applies *Deathstalker's Mark*, and
consuming it grants **Darkest Night**, which empowers the next **Eviscerate**.
