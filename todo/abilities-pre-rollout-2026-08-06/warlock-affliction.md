...
**Hero trees.** `builds.md` owns the pick. In kit terms: **Soul Harvester** adds
Demonic Soul stacking off shard spends and recycles **Dark Harvest**;
**Hellcaller** swaps Corruption for **Wither** and adds **Malevolence** as a
1-min cooldown. Where an ability belongs to one hero tree it is flagged in the
table.
