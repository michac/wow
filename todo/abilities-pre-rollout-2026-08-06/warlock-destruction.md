...
- **Hero trees:** `builds.md` owns the pick — and records it as a **genuine,
  still-contested S1 split**, so do not read a default out of this file. In kit
  terms: **Diabolist** cycles **Diabolic Ritual → Demonic Art → free Ruination**;
  **Hellcaller** replaces Immolate with **Wither** and adds the **Malevolence**
  burst cooldown. The tree changes your maintenance DoT and one major cooldown.
