...
- **Hero trees:** `builds.md` owns the pick. In kit terms: **Sunfury** adds
  **Spellfire Spheres** → Meteorites and **Invocation: Arcane Phoenix**;
  **Frostfire** replaces Fireball with **Frostfire Bolt**.
